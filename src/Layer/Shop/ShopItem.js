...
var ShopItem = ccui.Button.extend({
    ...
    updateStatus: function()
    {
        ...
        this._capacity = (this._configItem["key"].substring(0,3) !== "BDH") ? gv.json.townHall[gv.buildingSTR.townHall][cf.user._buildingList[gv.orderInUserBuildingList.townHall][0]._is_active ? cf.user._buildingList[gv.orderInUserBuildingList.townHall][0]._level : cf.user._buildingList[gv.orderInUserBuildingList.townHall][0]._level - 1][this._configItem["key"]] : "5";
        var currentQuantityText = this._currentQuantity.toString() + "/" + this._capacity.toString();
