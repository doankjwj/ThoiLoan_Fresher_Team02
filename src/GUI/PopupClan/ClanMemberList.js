var ClanMemberList = PopupClan.extend({
    ...
    ctor: function(){
        ...
        this._textJoin = cc.LabelBMFont("THÀNH VIÊN", font.soji20, 200, cc.TEXT_ALIGNMENT_CENTER);
    ...
    initUserList: function(){
        ...
        this._listUserVisualization.addEventListener(this.onScrolling, this);
    ...
    onScrolling: function(sender, type) {
        ...
        switch (type) {
            case ccui.ScrollView.EVENT_SCROLLING:
                if(this.getChildByTag(99) !== null) {
                    this.getChildByTag(99).visible = false;
                }
                break;
        }
