var PopupTraining = cc.Node.extend({
    ...
    addTroopToQueue: function (id) {
        ...
        // cc.log("CAPACITY : " + this.getTotalSlot());
        // cc.log("CURRENT QUEUE LENGTH : " + (this.getTotalQueueLength() + this.getTotalSlot() - this.getAvailableSlot()));
    ...
    quickFinish: function(){
        ...
        // cc.log(" ADAWD " + this.getAvailableSlot());

        cc.log(this.getTotalQueueLength() + this.getTotalSlot() - this.getAvailableSlot() );
